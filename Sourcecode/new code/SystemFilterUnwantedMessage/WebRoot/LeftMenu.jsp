		...
		<table align="left" width="100" height="200" border="0">
			...
			<tr>
				<td align="center" bgcolor="#055279">
					...
					<A href='MReport.jsp?auser=<%=user%>'
						style="text-decoration: none;"><font color="red" size="3">Message</font> </A>
			...
			<tr>
				<td align="center" bgcolor="#055279">
					...
					<a href="DisscussionForum.jsp"
					style="text-decoration: none;"><font color="red" size="3">Chating</font> </a>
				</td>
			</tr>
		</table>
	</body>
