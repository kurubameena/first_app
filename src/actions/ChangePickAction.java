...
public class ChangePickAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (flag) {
			response.sendRedirect("ChangePhoto.jsp?auser=" + user);
		} else
			response.sendRedirect("ChangePhoto.jsp?status=sorry try again");
		out.flush();
		out.close();
	}
